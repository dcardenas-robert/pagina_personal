<template>
  <section 
    id="experiencia" 
    class="py-8 sm:py-16 md:py-24 px-3 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800 w-full relative overflow-x-hidden"
    ref="experienceSection"
  >
    <div class="mx-auto max-w-4xl w-full">
      <div 
        class="text-center mb-6 sm:mb-12 md:mb-16 opacity-0 translate-y-10 transition-all duration-1000"
        :class="{ 'opacity-100 translate-y-0': isVisible }"
      >
        <h2 class="text-2xl sm:text-4xl md:text-5xl font-bold mb-2 sm:mb-4 text-gray-900 dark:text-white">
          Experiencia
        </h2>
        <p class="text-sm sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 px-2">
